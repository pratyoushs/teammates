...
<t:staticPage currentPage="features">
    <div id="contentHolderFeatures">
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Team peer evaluations</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Flexible feedback paths</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Powerful visibility control</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Fine-grain access control</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Different question types</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Reuse past questions</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">No signup required for students</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Shareable comments</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Student profiles</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Powerful search</h2>
        ...
        <div class="feature-details">
            <h2 id="captionFeatures">Support for big courses</h2>
